          ...
          <div className='hidden lg:flex'>
            <ul className="menu menu-horizontal p-1 border-dashed border-2 border-gray-50/0 hover:border-slate-200 rounded-full duration-300">
              ...
              <div className="tooltip tooltip-bottom" data-tip="My Projects">
                <li className='mr-3'><NavLink to='/projects' className='p-2 !rounded-full'><HiFolder className='text-2xl' /></NavLink></li>
              </div>
              <div className="tooltip tooltip-bottom" data-tip={theme}>
                <li><label className="swap swap-rotate !rounded-full p-2">
                  ...
                  <svg onClick={() => setTheme('dark')} className="swap-on fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z" /></svg>
