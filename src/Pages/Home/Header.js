        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-auto">
              <li><Link><HiHome /></Link></li>
              <li><Link><TiUser /></Link></li>
              <li><Link><HiFolder /></Link></li>
            </ul>
          </div>
          <div className='hidden lg:flex'>
            <ul className="menu menu-horizontal px-1">
              <li><NavLink to='/'><HiHome className='text-2xl' /></NavLink></li>
              <li><NavLink to='/about'><TiUser className='text-2xl' /></NavLink></li>
