...
const Home = () => {
  return (
    <div className='flex hero-content w-11/12 mx-auto'>
      <div>
        <ul>
          <li><a href="https://www.facebook.com/abdullahalanassaimon/" target='_blank'><FaFacebook className='text-2xl text-blue-500 hidden lg:block' /></a></li>
          <li><a href="https://www.linkedin.com/in/abdullahalanassaimon/" target='_blank'><FaLinkedin className='text-2xl text-blue-700 hidden lg:block' /></a></li>
          <li><a href="https://github.com/AbdullahAlAnasSaimon/" target='_blank'><FaGithub className='text-2xl text-slate-700 hidden lg:block' /></a></li>
        </ul>
        <p className='rotate-[270deg]'>Follow Me On</p>
      </div>
